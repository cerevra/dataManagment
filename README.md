...
Каждое решение или несколько решений (стратегий) должны быть реализованы в виде плагинов. Образец прилагается (plugins/template). Полученную стратегию следует расположить в каталоге bin/plugins.
